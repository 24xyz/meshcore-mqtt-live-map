...
- `VERSION.txt` tracks the current version (now `1.9.5`); append changes in `VERSIONS.md`.
...
- `APP_BASE_PATH` lets the site run under a public subpath such as `/livemap`; when unset, the app remains rooted at `/`.
